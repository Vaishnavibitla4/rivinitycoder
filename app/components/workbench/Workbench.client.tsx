        ...
        >
          ...
          >
            <div className="absolute inset-0 px-2 lg:px-4">
              <div className="relative h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
