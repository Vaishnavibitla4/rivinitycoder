        ...
        <div className="flex flex-col lg:flex-row overflow-y-auto w-full h-full">
          ...
          >
            ...
            >
              <StickToBottom.Content className="flex flex-col gap-4 relative ">
                <ClientOnly>
                  {() => {
                    return chatStarted ? (
                      <Messages
                        className="flex flex-col w-full flex-1 max-w-full pb-4 mx-auto z-1 px-4"
                        messages={messages}
              ...
              <div
                className={classNames('my-auto flex flex-col gap-2 w-full max-w-full mx-auto z-prompt mb-6 px-4', {
